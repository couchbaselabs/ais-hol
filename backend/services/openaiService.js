...
export async function generateResponse(userMessage, systemPrompt = null) {
  try {
    ...
    // TODO: Implement OpenAI completion logic here
    // Use the systemPrompt and userMessage to call the OpenAI API
    // Example:
    // const completion = await openai.chat.completions.create({ ... })
    // return completion.choices[0]?.message?.content.trim()

    // Placeholder response for workshop
    return "[AI response will appear here. Implement OpenAI completion logic.]"
