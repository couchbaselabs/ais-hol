...
export const MODULES = [
  ...
  {
    id: 'ai-data-plane-ai-functions',
    title: 'Couchbase AI Data Plane',
    icon: '🗄️',
    level: 'advanced',
    tabs: [
      { id: 'ai-data-plane-intro',          label: '🗄️ Introduction' },
      { id: 'ai-data-plane-service',        label: '🗄️ AI Data Plane' },
      { id: 'ai-data-plane-summarise',      label: '🗄️ AI Summarisation' },
      { id: 'ai-data-plane-sentiment',      label: '🗄️ AI Sentiment' },
      { id: 'ai-data-plane-classification', label: '🗄️ AI Classification' },
      { id: 'ai-data-plane-extraction',     label: '🗄️ AI Extraction' },
      { id: 'ai-data-plane-translation',    label: '🗄️ AI Translation' },
      { id: 'ai-data-plane-masking',        label: '🗄️ AI Masking' },
      { id: 'ai-data-plane-similarity',     label: '🗄️ AI Similarity' },
      { id: 'ai-data-plane-completion',     label: '🗄️ AI Completion' },
      { id: 'ai-data-plane-grammar',        label: '🗄️ AI Grammar' },
    ],
  },
  {
    id: 'ai-data-plane-models',
    title: 'Couchbase AI Data Plane Models',
    icon: '🤖',
    level: 'advanced',
    tabs: [
      { id: 'ai-data-plane-model-guardrails',  label: '🛡️ Guardrails' },
      { id: 'ai-data-plane-model-cache',       label: '⚡ Semantic Cache' },
      { id: 'ai-data-plane-model-providers',   label: '🔀 Model Providers' },
      { id: 'ai-data-plane-model-ratelimit',   label: '🚦 Rate Limiting' },
    ],
  },
  {
    id: 'ai-data-plane-workflows',
    title: 'Couchbase AI Data Plane Workflows',
    icon: '⚙️',
    level: 'advanced',
    tabs: [
      { id: 'ai-data-plane-ingestion',      label: '⚙️ Ingestion Pipeline' },
    ],
  },
  {
    id: 'agent-memory',
