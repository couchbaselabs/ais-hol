...
import './CapellaDiyBanner.css'

/**
 * A slim banner shown at the top of each Capella AI Functions tab.
 ...
 * Capella collapses into a single SQL++ query.
 *
 ...
 */
export default function CapellaDiyBanner({ diyTab, diyLabel, replaces }) {
  function navigate() {
